...
export default function SubscriptionPage() {
  ...
  useEffect(() => {
    const fetchSubscriptionProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch('/api/products/subscription');
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-12 max-w-md mx-auto border border-white/10">
                    ...
                    <p className="text-gray-400">
                      No subscription products available in this category at the
                      moment.
                    </p>
                  </div>
                </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-3xl p-12 border border-white/10">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of users who trust us for their subscription needs. Get
              instant access and exclusive deals!
            </p>
