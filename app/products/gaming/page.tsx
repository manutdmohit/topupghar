...
export default function GamingPage() {
  ...
  const transformProductToCardProps = (product: Product) => {
    ...
    let badge = 'GAMING';
    if (product.platform.toLowerCase().includes('freefire')) {
      badge = 'BESTSELLER';
    } else if (product.platform.toLowerCase().includes('pubg')) {
      badge = 'HOT DEAL';
    } else if (
      product.platform.toLowerCase().includes('garena') ||
      product.platform.toLowerCase().includes('shell')
    ) {
      badge = 'POPULAR';
    }
    ...
    return {
      ...
      isPopular: product.platform.toLowerCase().includes('freefire'),
