...
const courseraPackages = [
  {
    id: 1,
    label: 'Coursera Plus (1 Year)',
    duration: '1 Year',
    price: 8499,
  },
];
...
export default function CourseraPlusPage() {
  ...
  const handleBuyNow = () => {
    const pkg = courseraPackages.find((p) => p.id === selectedPackage);
    if (!pkg) return;
    ...
    <div className="max-w-xl mx-auto px-4 py-10">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-2">
          Unlimited access to top courses and certificates for a full year. Fast
          delivery after payment.
        </p>
        <div className="mt-6 flex justify-center">
          <Image
            src="/coursera-plus.jpg"
            alt="Coursera Plus"
            width={500}
            height={500}
        ...
        {courseraPackages.map((pkg) => (
          ...
          >
            ...
            <div className="mt-2 text-xs text-gray-500">
              1 Year Access | Unlimited Courses & Certificates
            </div>
            {selectedPackage === pkg.id && (
