...
const nordvpnPackages = [
  {
    id: 1,
    label: 'NordVPN (1 Year)',
    duration: '1 Year',
    price: 1899,
    type: '1year',
  },
...
export default function NordVpnPage() {
  ...
  const handleBuyNow = () => {
    const pkg = nordvpnPackages.find((p) => p.id === selectedPackage);
    if (!pkg) return;
    ...
    <div className="max-w-xl mx-auto px-4 py-10">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-2">
          Secure your internet with NordVPN. Choose your plan below.
        </p>
